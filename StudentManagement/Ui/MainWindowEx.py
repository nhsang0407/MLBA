...
from StudentManagement.Ui.MainWindow import Ui_MainWindow
...
class MainWindowEx(Ui_MainWindow):
    ...
    def pickAvatar(self): #chi luu tam thoi vao thanh ram
        ...
        self.labelAvatar.setPixmap(pixmap)
        self.labelAvatar.setScaledContents(True) #anh vua khung
